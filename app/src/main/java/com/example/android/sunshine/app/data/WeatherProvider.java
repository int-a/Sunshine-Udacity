...
public class WeatherProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                // return item type because location & date specify one weather entry?
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;
            case WEATHER_WITH_LOCATION:
                // return dir type (specified in WeatherContract) because location alone will return a week's worth of weather?
        ...
        // is this going to return a cursor of type item or dir?
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                SQLiteQueryBuilder queryBuilderWeather = new SQLiteQueryBuilder();
                queryBuilderWeather.setTables(WeatherContract.WeatherEntry.TABLE_NAME);
                retCursor =  queryBuilderWeather.query(mOpenHelper.getReadableDatabase(),
                        projection,
                        selection,
                        selectionArgs,
                        null,
            ...
            // "location"
            case LOCATION: {
                SQLiteQueryBuilder queryBuilderLocation = new SQLiteQueryBuilder();
                queryBuilderLocation.setTables(WeatherContract.LocationEntry.TABLE_NAME);
                retCursor =  queryBuilderLocation.query(mOpenHelper.getReadableDatabase(),
                        projection,
                        selection,
                        selectionArgs,
                        null,
